const SONGS_DATABASE = [
    ...
    },
    {
        ...
        blanksCount: 4,
        lyrics: [
            { text: "We were young, posters on the", blank: true, correctAnswer: "wall", options: ["wall", "floor", "door", "hall"] },
            { text: "Praying we're the ones that the teacher wouldn't", blank: true, correctAnswer: "call", options: ["call", "see", "find", "stop"] },
            { text: "We were lost in our", blank: true, correctAnswer: "defense", options: ["defense", "pretense", "silence", "conscience"] },
            { text: "Rebels without a", blank: true, correctAnswer: "cause", options: ["cause", "pause", "loss", "clause"] }
        ]
    },
    {
        id: 8,
